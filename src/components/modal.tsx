        ...
        <>
          ...
          >
            <motion.div
              ...
              className={`${modalSizes[size]} relative mx-auto w-full rounded-xl border-2 border-white bg-background p-4 text-foreground shadow-xl ring-1 ring-border sm:p-6`}
