...
export default function DashboardNav({ role, userName }: DashboardNavProps) {
  ...
  return (
    <>
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-gray-100 px-4 py-4">
            ...
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-gray-600 transition-all duration-200 hover:bg-gray-50 hover:text-gray-900 cursor-pointer"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Mobile bottom nav */}
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white/95 backdrop-blur-xl lg:hidden">
