...
export default function Navbar({ entryDelay = 1.15 }: NavbarProps) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.72, delay: entryDelay, ease: [0.2, 0.9, 0.2, 1] }}
        className="pointer-events-none absolute left-0 top-0 h-full w-full origin-center rounded-lg border-2 border-white bg-[#f6f6f6]/50 shadow-[0_-3px_6px_rgba(255,255,255,1),0_-1px_0px_rgba(255,255,255,1),0_8px_16px_rgba(0,0,0,0.12),0_3px_6px_rgba(0,0,0,0.08),1px_0_2px_rgba(0,0,0,0.03),-1px_0_2px_rgba(0,0,0,0.03)] backdrop-blur-xl"
      />
